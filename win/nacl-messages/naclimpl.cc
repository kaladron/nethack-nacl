...
winid nacl_create_nhwindow(int type) { return 0;}
...
int  nacl_select_menu(winid wid, int how, MENU_ITEM_P **selected) { return 0;}
...
int  nacl_nhgetch(void) { return 0;}
int  nacl_nh_poskey(int *x, int *y, int *mod) { return 0;}
void nacl_nhbell(void) {}
int  nacl_doprev_message(void) { return 0;}
char nacl_yn_function(const char *question, const char *choices,
                CHAR_P def) {}
void nacl_getlin(const char *question, char *input) {}
int  nacl_get_ext_cmd(void) { return 0;}
